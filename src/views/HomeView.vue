    ...
    <body>
          ...
          <nav class="header-nav">
            <ul class="list-reset header-list flex">
              <li class="header-list-item">
                <a href="#" class="header-link">Домашняя страница</a>
              </li>
              <li class="header-list-item">
              ...
              <li class="header-list-item">
                <a href="#clients" class="header-link">Отзывы</a>
              </li>
              <li class="header-list-item">
                <a href="#contacts" class="header-link">Контакты</a>
              </li>
              <li class="header-list-item">
                <a href="#join-us" class="header-link">Присоединиться</a>
              </li>
            </ul>
          </nav>
          <button
            class="btn header-btn btn-reset"
            color="#F8F7F7"
            @click="loginForm()"
            v-if="auth === false"
          >
            <span id="headerlink-black">Логин</span>
          </button>
          <div v-else>
            <button class="header-btn btn-reset" color="#F8F7F7">
              <span class="header-login-name">Рустам</span>
            </button>
            <button class="btn header-btn btn-reset" color="#F8F7F7">
              <span class="span-margin" @click="loginForm()">Выйти</span>
            </button>
          </div>
          <!-- <button class="btn header-btn btn-reset">Войти</button> -->
        </div>
      </header>
      ...
      <main class="main">
        <section id="hero" class="hero">
          <div class="container">
            <div class="hero-content flex">
              <h1 class="hero-title">
                Самый разумный способ учиться онлайн у нас
              </h1>
              <p class="hero-descr">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Incidunt dolor animi atque unde harum ut&nbsp;esse delectus
                placeat veritatis repudiandae, libero alias, aut optio! Odio
                nulla recusandae atque eius quia?
              </p>
              <div class="hero-wrapper">
                <button class="btn hero-btn btn-reset">
                  Бесплатный 30-дневный доступ
                </button>
                <span class="hero-secure">Защищенное SSL соединение</span>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="services-content">
              ...
              <p class="section-descr services-descr">
                Наша школа поможет вам получить знания по многим дисциплинам.
              </p>
              <ul class="list-reset services-list flex">
                <li class="services-list-item flex">
                  ...
                  <h3 class="services-list-item-title">Математика</h3>
                  <p class="services-item-list-descr">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Hic placeat praesentium perferendis molestias ducimus! Quam
                    omnis deserunt quisquam optio nesciunt sit nam beatae natus,
                    placeat laudantium sunt quae exercitationem perspiciatis.
                  </p>
                </li>
                <li class="services-list-item flex">
                  <svg
                  ...
                  <h3 class="services-list-item-title">Русский язык</h3>
                  <p class="services-item-list-descr">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Hic placeat praesentium perferendis molestias ducimus! Quam
                    omnis deserunt quisquam optio nesciunt sit nam beatae natus,
                ...
                <li class="services-list-item flex">
                  ...
                  <h3 class="services-list-item-title">Информатика</h3>
                  <p class="services-item-list-descr">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Hic placeat praesentium perferendis molestias ducimus! Quam
                    omnis deserunt quisquam optio nesciunt sit nam beatae natus,
                ...
                <li class="services-list-item flex">
                  ...
                  <h3 class="services-list-item-title">Физика</h3>
                  <p class="services-item-list-descr">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Hic placeat praesentium perferendis molestias ducimus! Quam
                    omnis deserunt quisquam optio nesciunt sit nam beatae natus,
                  ...
                  <article class="blog-preview flex">
                    ...
                    <div class="blog-preview-text">
                      <time
                        ...
                        datetime="2022-12-30 01:00"
                      >
                        1 Сетнября - 1 Июня 2023
                      </time>
                      <h3 class="blog-preview-title">Все включено</h3>
                      <p class="blog-preview-descr">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Repudiandae ipsum quis quidem natus repellendus incidunt
                        placeat iure veniam esse magni maiores adipisci illo
                        perferendis, unde pariatur. Porro enim exercitationem
                        vitae.
                      </p>
                    </div>
                  </article>
                  ...
                  <article class="blog-preview flex">
                    ...
                    <div class="blog-preview-text">
                      <time
                        ...
                        datetime="2022-12-30 01:00"
                      >
                        1 Сетнября 2022 - 1 Января 2023
                      </time>
                      <h3 class="blog-preview-title">Полугодовой курс №1</h3>
                      <p class="blog-preview-descr">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Repudiandae ipsum quis quidem natus repellendus incidunt
                        placeat iure veniam esse magni maiores adipisci illo
                  ...
                  <article class="blog-preview flex">
                    ...
                    <div class="blog-preview-text">
                      <time
                        ...
                        datetime="2022-12-30 01:00"
                      >
                        1 Января 2023 - 1 Июня 2023
                      </time>
                      <h3 class="blog-preview-title">Полугодовой курс №2</h3>
                      <p class="blog-preview-descr">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Repudiandae ipsum quis quidem natus repellendus incidunt
                        placeat iure veniam esse magni maiores adipisci illo
                  ...
                  <article class="blog-preview flex">
                    ...
                    <div class="blog-preview-text">
                      <time
                        ...
                        datetime="2022-12-30 01:00"
                      >
                        1 Сентября 2022 - 1 Октября 2023
                      </time>
                      <h3 class="blog-preview-title">Месячный доступ</h3>
                      <p class="blog-preview-descr">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit.
                        Repudiandae ipsum quis quidem natus repellendus incidunt
                        placeat iure veniam esse magni maiores adipisci illo
        ...
        <section id="clients" class="clients section-offset">
          <div class="container">
            <div class="clients-content">
              <h2 class="section-title clients-title">Отзывы</h2>
              <ul class="list-reset clients-list flex">
                <li class="clients-list-item flex">
                  <p class="clients-list-item-descr">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad
                    rem consectetur necessitatibus cupiditate quo minus corrupti
                    at fuga impedit quasi, delectus veniam suscipit similique
                    ducimus eos ea ipsa quia! Repudiandae?
                  </p>
                  <div class="clients-user flex">
                    <div class="clients-avatar">
                      <img src="@/../public/img/clients-1.jpg" alt="Name" />
                    </div>
                    <div class="clients-text">
                      <div class="clients-name">Вотяков Александр</div>

                      <span class="clients-post"
                        >Студент 2 курса, Бауманка</span
                      >
                    </div>
                  </div>
                </li>
                <li class="clients-list-item flex">
                  ...
                  <div class="clients-user flex">
                    <div class="clients-avatar">
                      <img src="@/../public/img/clients-2.jpg" alt="Name" />
                    </div>
                    <div class="clients-text">
                      <div class="clients-name">Воронина Татьяна</div>
                      <span class="clients-post">Студентка 1 курса, МГУ</span>
                    </div>
                  </div>
                </li>
                <li class="clients-list-item flex">
                  ...
                  <div class="clients-user flex">
                    <div class="clients-avatar">
                      <img src="@/../public/img/clients-3.jpg" alt="Name" />
                    </div>
                    <div class="clients-text">
                      <div class="clients-name">Коваль Максим</div>
                      <span class="clients-post">Преподаватель в школе</span>
                    </div>
                  </div>
                </li>
              </ul>
            ...
            <div class="contacts-content">
              ...
              <address class="contacts-adress">
                <ul class="list-reset contacts-list flex">
                  <li class="contacts-list-item flex contacts-item-addres">
                    <strong class="contacts-item-caption">Посетите нас</strong>
                    <p class="contacts-list-item-text">
                      Lorem ipsum dolor sit amet.
                    </p>
                  </li>
                  <li class="contacts-list-item flex contacts-item-call">
                    <strong class="contacts-item-caption">Позвоните нам</strong>
                    <a href="tel:+79998887766" class="contacts-list-item-link"
                      >+7 (999) 888-77-66</a
                    >
                    <a href="tel:+79998887766" class="contacts-list-item-link"
                      >+7 (999) 888-77-66</a
                  ...
                  <li class="contacts-list-item flex contacts-item-mail">
                    <strong class="contacts-item-caption">Напишите нам</strong>
                    <a
        ...
        <!-- <section id="join-us" class="join-us section-offset">
          <div class="container">
            <h2 class="section-title join-us-title">Присоединяйтесь к нам</h2>
            <p class="section-descr join-us-descr">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nostrum
              minus itaque tenetur, similique incidunt esse dignissimos harum
              expedita reprehenderit, modi tempore! Reiciendis sequi dolore
              aspernatur perferendis, aliquid eligendi. Cum, ad.
            </p>
            <form
            ...
            >
              <div class="form-top">
                <div class="form-left">
                  ...
                  <select class="form-select" name="country">
                    ...
                    <option value="BU">Белоруссия</option>
              ...
              <div class="form-bottom">
                <div class="form-wrapper">
                  <button class="btn btn-reset form-btn">Начать</button>
                  <label class="form-check">
                    <input type="checkbox" required />
                    <span
                      >Я согласен с
                      <a href="#">пользовательским соглашением</a></span
                    >
                  </label>
                </div>
              </div>
      ...
      <footer class="footer">
        <div class="container flex footer-container">
          ...
          <div class="footer-right flex">
            <nav class="footer-nav">
              <ul class="list-reset footer-list flex">
                <li class="footer-list-item">
                  <a href="#" target="_blank" class="footer-link">О нас</a>
                </li>
                <li class="footer-list-item">
            ...
            <ul class="list-reset footer-socials flex">
              <li class="footer-socials-item">
                <a href="#" class="footer-socials-link social-link-twitter"></a>
              </li>
              <li class="footer-socials-item">
                <a
                  href="#"
                  class="footer-socials-link social-link-linkedin"
                ></a>
              </li>
              <li class="footer-socials-item">
                <a href="#" class="footer-socials-link social-link-mail"></a>
              </li>
            </ul>
          </div>
        </div>
...
.hero {
  ...
  background-image: url("@/../public/img/hero-back.jpg");
  background-size: cover;
  background-repeat: no-repeat;
  background-position: center;
  /* , :url('/img/hero-back.jpg'):src="require(project.img_url)" */
}
...
.hero-secure {
  ...
  color: #787878;
  text-transform: uppercase;
  background-image: url("@/../public/img/secure.svg");
  background-position: left center;
  block-size: 14px 17px;
  background-repeat: no-repeat;
  padding-left: 30px;
}
...
.services-list-item:not(:nth-child(4n)) {
  margin-right: 30px;
}
...
.contacts-item-call {
  background-image: url("@/../public/img/phone.svg");
}
...
.contacts-list-item:not(:nth-child(3n)) {
  margin-right: 30px;
}
...
.social-link-twitter {
  background-image: url("@/../public/img/twitter-logo.svg");
}

.social-link-linkedin {
  background-image: url("@/../public/img/in-logo.svg");
}
